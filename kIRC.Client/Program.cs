...
using kIRC.Client.Models;

namespace kIRC.ClientApp;

internal class Program
{
    private static HubConnection _connection;
    private static List<ClientModel> _clients = new();
    ...
    private static async Task ConnectAsync()
    {
        ...
        _connection.On<string, List<ClientModel>>("clientJoined",
            (userName, clients) =>
            {
                _clients = clients;
        ...
        _connection.On<List<ClientModel>>("getUsers", (clients) =>
        {
            _clients = clients;
    ...
    private static async Task SendPM(string userName, string msg)
    {
        try
        {
            ClientModel? client = _clients.FirstOrDefault(client => client.UserName == userName);
